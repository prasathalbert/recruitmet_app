...
class Gkmemployees extends CI_Controller {
	...
	public function __construct()
	{
        ...
        global $gkm_employees;
        $designation_list=$this->users_model->getDesignation("DesignationId in (".$gkm_employees.")");	
	...
	public function index()
	{
	   global $gkm_employees;
		$data = array(
						...
						"title"=>"GKM Employees List",
						"current_menu"=>"gkmemployees",
                        "employees" => $this->users_model->getUserUserDetail("u.DesignationId in (".$gkm_employees.")"),
                        "error" => $this->msg
						);
    ...
    public function save()
	{
		...
		{            
			if($this->form_validation->run('add_gkm_employee') == TRUE) 
			{
                if($this->input->post("bpassword")==$this->input->post("brepassword"))
                {
    				...
    				if($res == false)
    				{
    				    $ins_array = array(
                                        ...
                                        "DesignationId"=>$this->input->post("bdesignation"),
	...
	public function edit($employeeid)
	{
       ...
       $empdata=null;
		...
		$data = array(
						...
						"title"=>"Edit GKM Employee Details",
						"current_menu"=>"gkmemployees",
    ...
    public function update()
    {
		...
		{            
			if($this->form_validation->run('edit_gkm_employee') == TRUE) 
			{
