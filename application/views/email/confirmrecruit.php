              ...
              <tr>
                ...
                <td valign="top">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="font-family: Verdana; font-size:16px; color:#555555; line-height:22px; padding-bottom:10px;" align="left"> <br /> Hi <?php echo $name; ?>, </td>
                    </tr>
                    <tr>
                        <td style="font-family: Verdana; font-size:12px; color:#222222; line-height:19px; padding-bottom:7px;" align="left">
                           

                            Please find attached the soft copy of your appointment order and the salary breakup. Kindly update us with your current address, pincode to dispatch the hard copy of your appointment order.
                            
                            <br /><br />
                            Kindly confirm us the recruit and let us know whethere you have accepted the offer.
                        </td>
                    </tr>
