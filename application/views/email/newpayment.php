        ...
        <tr>
            <td style="font-family: Verdana; font-size:12px; color:#222222; line-height:19px; padding-bottom:7px;" align="left">
                ...
                <table width="100%" cellspacing="0" bordercolor="#d9d9d9" cellpadding="5" border="1">
                    <tr><td width="50%">New Recuit Name</td><td><?php echo $recruitname; ?></td></tr>
                    <tr><td>New Recuit Email</td><td><?php echo $recruitemail; ?></td></tr>
                    <tr><td>New Recuit Comments</td><td><?php echo $comments; ?></td></tr>
                </table> 
            </td>
        </tr>
