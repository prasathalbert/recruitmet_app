...
<?php
    ...
    $frm = array("name"=>"recruitment-uploadoffer-frm","id"=>"recruitment-uploadoffer-frm","method"=>"post",  "enctype"=>"multipart/form-data");
	echo form_open("recruitment/uploadoffer_save",$frm);  
...
<div id="b_right" style="float: none; margin: 0;">
	...
	echo getErrorMsg($error);
        ...
        <div><br />
            <div id="i_title">
                <label for="auform_file">Upload Offer Letter</label>
            ...
            <div id="i_publish">
    			<ul>
    				...
    				<li><input type="submit" class="sub_button" name="upload_offer" value="Upload" /></li>
